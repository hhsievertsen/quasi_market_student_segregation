...
In the study we also use a randomisation adjustment to account for systematic differences across regions. See the paper for further details [here, (forthcoming)](https://github.com/hhsievertsen/hhsievertsen.github.io/raw/master/mat/accepted/2021_JPART.pdf). Note that we also share all our Stata files for the actual analysis [here](https://github.com/hhsievertsen/quasi_market_student_segregation).
...
As this is an example of a simple Difference-in-Difference with only two periods and two groups, we can obtain our Difference-in-Differences estimate by comparing means. In the code below we calculate and print the mean before treatment in the Control group. You can adjust the code to get the means for the other groups and to calculate the Difference-in-Differences (or click "hint").
...
We can also get the Difference-in-Differences estimate by means of a regression approach. We estimate the model with ordinary least squares. 

We first prepare the data. We need to 
